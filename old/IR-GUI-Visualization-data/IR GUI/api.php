...
if ( ! isset( $_GET['call'] ) ) {
    ...
    echo json_encode( [
        'rumor_percentage' => [
            'true_rumor_percentage'  => 10,
            'false_rumor_percentage' => 60,
            'other_rumor_percentage' => 30,
        ],
        'rumor_counts'     => [
            'tweet_true_rumor'  => 125230,//R
            'tweet_false_rumor' => intval( 125230 / 30 * 40 ), // pick 40% as integerumor Not Rumor
            'tweet_other_rumor' => 125230,// Impossbile Rumor
            'tweets'            => intval( 125230 / 30 * 100 ),//Tweets
            'articles'          => 153,
        ],
        'tweet_histogram'  => [
